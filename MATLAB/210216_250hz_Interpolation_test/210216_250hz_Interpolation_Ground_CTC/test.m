...
joint_torque = joint_torque(S:S+3000,:);
out_joint_torque = out_joint_torque(S:S+3000,:);
A_L_Des_X = A_L_Des_X(S:S+3000,:);
A_L_Foot_Pos = A_L_Foot_Pos(S:S+3000,:);
G_L_Des_X = G_L_Des_X(S:S+3000,:);
G_L_Foot_Pos = G_L_Foot_Pos(S:S+3000,:);
O_L_Des_X = O_L_Des_X(S:S+3000,:);
O_L_Foot_Pos = O_L_Foot_Pos(S:S+3000,:);
