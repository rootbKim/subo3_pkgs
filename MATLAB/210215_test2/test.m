...
Des_X_A = Des_X_A(1:700,:);
Foot_Pos_A = Foot_Pos_A(1:700,:);
Foot_Pos_dot_A = Foot_Pos_dot_A(1:700,:);
joint_torque_A = joint_torque_A(1:700,:);
out_joint_torque_A = out_joint_torque_A(1:700,:);
...
Q_A = readmatrix('Q_A.txt');
QDot_A = readmatrix('QDot_A.txt');
...
Q_G = readmatrix('Q_G.txt');
QDot_G = readmatrix('QDot_G.txt');
