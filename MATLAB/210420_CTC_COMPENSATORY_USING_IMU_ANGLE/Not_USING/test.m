...
tmpdata21 = readmatrix("tmpdata21.txt");
tmpdata22 = readmatrix("tmpdata22.txt");
tmpdata23 = readmatrix("tmpdata23.txt");
tmpdata24 = readmatrix("tmpdata24.txt");
tmpdata25 = readmatrix("tmpdata25.txt");

S_total = min([length(tmpdata0),length(tmpdata1),length(tmpdata2),length(tmpdata3),length(tmpdata4),length(tmpdata5),length(tmpdata6),length(tmpdata7),length(tmpdata8),length(tmpdata9),length(tmpdata10),length(tmpdata11),length(tmpdata12),length(tmpdata13), length(tmpdata14),length(tmpdata15),length(tmpdata16),length(tmpdata17),length(tmpdata18),length(tmpdata19),length(tmpdata20),length(tmpdata21),length(tmpdata22),length(tmpdata23),length(tmpdata24),length(tmpdata25)]);

S = S_total-100; % 3280~3275
...
tmpdata21 = tmpdata21(1:S,:);
tmpdata22 = tmpdata22(1:S,:);
tmpdata23 = tmpdata23(1:S,:);
tmpdata24 = tmpdata24(1:S,:);
tmpdata25 = tmpdata25(1:S,:);
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Left Body Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Right Body Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Left Body Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Right Body Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Pelvis CTC Left Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
plot(time, A_L_Des_X, 'linewidth', 2)
legend("x", "y", "z", "r", "p", "y")
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Pelvis CTC Right Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
plot(time, A_R_Des_X, 'linewidth', 2)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Left Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
plot(time, G_L_Des_X, 'linewidth', 2)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Right Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
plot(time, G_R_Des_X, 'linewidth', 2)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Left Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Right Des Pos','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m] / Angular [rad]','FontSize',14)
plot(time, O_R_Des_X, 'linewidth', 2)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Left Body Pos dot','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m/s] / Angular [rad/s]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('Two Foot CTC Right Body Pos dot ','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m/s] / Angular [rad/s]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Left Body Pos dot','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m/s] / Angular [rad/s]','FontSize',14)
...
fig.Color = 'White';
set(gca,'FontSize',14)
title('One Foot CTC Right Body Pos dot','FontSize',16)
xlabel('Time [sec]','FontSize',14)
ylabel('Linear [m/s] / Angular [rad/s]','FontSize',14)
